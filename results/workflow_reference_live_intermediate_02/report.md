...
|---|---|---|---:|---:|---:|---:|---:|---:|---:|
|intermediate_retraction|root_gate|fault_and_action_observed|0|1|0|2|0|18|0|
|intermediate_retraction|dependency|fault_and_action_observed|0|0|0|0|0|30|0|
|intermediate_retraction|dependency_push|no_post_fault_action_opportunity|0|0|0|0|0|21|0|

## 运行有效性计数

|条件|机制|实际注入故障|模型 hold|模型无效动作|worker error|未实现阶段|上游未实现任务|
|---|---|---:|---:|---:|---:|---:|---:|
|intermediate_retraction|root_gate|1|3|1|0|1|1|
|intermediate_retraction|dependency|1|3|1|0|0|0|
|intermediate_retraction|dependency_push|1|7|0|0|0|0|
